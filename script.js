// Declares and store all the possible characters in a variable called chars
const chars = "0123456789abcdefghijklmnopqrstuvwxyz!@#$%^&*()ABCDEFGHIJKLMNOPQRSTUVWXYZ";

// Declares a variable called passwordLength and assign its value to 8
let passwordLength = 8;

// Stores the password-el paragraph in a variable called passwordEL
...
// Creates a function copyToClipboard() that copies selected password just clicking on it
